...
export const LESSONS: Lesson[] = [
  ...
  practice(23),
  L(24, 'u (second sound)', [], ['put', 'pull', 'push']),
  practice(25),
  ...
  practice(46),
  L(47, 'sl, sp, st', ['sl', 'sp', 'st']),
  practice(48),
  L(49, 'lb, ld, lf, lk + calf, half, talk, walk', ['lb', 'ld', 'lf', 'lk'], ['calf', 'half', 'talk', 'walk']),
  practice(50),
  L(51, 'lm, lp, lt, mp, tch + halt', ['lm', 'lp', 'lt', 'mp', 'tch'], ['halt']),
  practice(52),
  ...
  practice(60),
  L(61, 'sl, shr, sm, sn, sp, spl, spr', ['shr', 'sm', 'sn', 'spl', 'spr']),
  ...
  practice(71),
  L(72, 'ay + away', ['ay'], ['away']),
  practice(73),
  L(74, 'eigh + height', ['eigh'], ['height']),
  practice(75),
  L(76, 'au, aw', ['au', 'aw']),
  practice(77),
  L(78, 'a (broad), ar', []),
  ...
  L(103, 'o_e', ['o_e']),
  practice(104),
  L(105, 'oa, ow, old', ['oa', 'ow']),
  practice(106),
  L(107, 'contractions, oo', ['oo']),
  practice(108),
  L(109, 'ow, ou', ['ou']),
